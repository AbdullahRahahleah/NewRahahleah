...
/*
 * Here I define every value which I recieved from the JSON object as a local variable(with using getter,setter)
 * because I need to display specific values on other placse ( I was being able to use List instead of local variable)
 * 
 */
